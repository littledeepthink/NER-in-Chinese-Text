...
from keras.layers import Input, Embedding, Bidirectional, LSTM, Dropout,\
                         TimeDistributed, Concatenate, Dense
...
class BiLSTM_CRF():
    ...
    def __init__(self, n_input_char, char_embedding_mat, n_input_word,
                  n_vocab_word, n_embed_word, keep_prob, n_lstm, keep_prob_lstm,
                  n_entity, optimizer, batch_size, epochs,
        ...
        self.n_vocab_word = n_vocab_word
        self.n_embed_word = n_embed_word
    ...
    def build(self):
        ...
        lstm = LSTM(self.n_lstm, return_sequences=True,
                    dropout=self.keep_prob_lstm,
